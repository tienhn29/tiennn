...
public class CauHoiDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db1) {
        String sql1 = "CREATE TABLE cauhoi (\n" +
                ...
                "    dapan  INT (8)       NOT NULL\n" +
                ");\n";
        db1.execSQL(sql1);

        sql1 = "INSERT INTO cauhoi (cauhoi,dapan1,dapan2,dapan3,dapan) VALUES ('Khái niệm \"đường bộ\" được hiểu như thế nào là đúng? Đường bộ gồm:','Đường bộ, cầu đường bộ.','Hầm đường bộ, bến phà đường bộ.','Đường, cầu đường bộ, hầm đường bộ, bến phà đường bộ và các công trình phụ trợ khác.',1)";
        db1.execSQL(sql1);
        sql1 = "INSERT INTO cauhoi (cauhoi,dapan1,dapan2,dapan3,dapan) VALUES ('\"Phương tiện giao thông đường bộ\" gồm những loại nào?','Phương tiện giao thông cơ giới đường bộ, phương tiện giao thông thô sơ đường bộ.','Phương tiện giao thông thô sơ đường bộ, phương tiện giao thông cơ giới đường bộ và xe máy chuyên dùng.','Cả hai ý nêu trên.',2)";
        db1.execSQL(sql1);
